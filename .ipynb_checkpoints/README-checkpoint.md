...
```bash
# Clone repository
git clone https://github.com/dikshakash/ChurnShield-AI.git
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue)](https://www.linkedin.com/in/diksha-kashyap)  
